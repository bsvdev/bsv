...
public class ShowGroupsTest {
	...
	public void badArgumentsTest() {
		...
		try {
			new ShowGroups(this.groupController, null, null);
			Assert.fail("Controller was null");
		} catch (IllegalArgumentException e) {
			// ok
		}
		...
		try {
			new ShowGroups(null, this.selectionController, null);
			Assert.fail("Controller was null");
		} catch (IllegalArgumentException e) {
			// ok
		}
		...
		try {
			new ShowGroups(null, null, this.subspaceController);
			Assert.fail("Controller was null");
		} catch (IllegalArgumentException e) {
			// ok
		}
	...
	public void realTest() {
		this.showGroups = new ShowGroups(this.groupController,
				this.selectionController, this.subspaceController);
		Assert.assertNotNull(this.showGroups);
		Assert.assertEquals(true, this.showGroups.isVisible());
	}
